...
| Version | Changes |
| :--- | :--- |
| **Version 1.0.0** | * Refactored internal data storage from name-keyed to UUID-keyed actor flags for improved data integrity<br>* Added one time migration for beta-testers<br>* Additional documentation improvements before public releaseAdditional documentation improvements before public release |
